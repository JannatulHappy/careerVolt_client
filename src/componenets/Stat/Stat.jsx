...
function Stat() {
  return (
    <>
      <div class="mx-auto max-w-7xl mt-10 mb-20  lg:mb-24">
        <div class="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          <div class="flex justify-center w-full lg:border-r border-gray-300 py-6">
            ...
            <div class="  pl-12 w-1/2">
              <h1 class="font-bold text-2xl lg:text-5xl tracking-1px">150</h1>
          ...
          <div class="flex justify-center w-full lg:border-r border-gray-300 py-6">
            ...
            <div class="  w-1/2 pl-12">
              <h1 class="font-bold text-2xl lg:text-5xl tracking-1px">1000+</h1>
              <h2 class="text-base lg:text-lg mt-4 leading-8 tracking-wide">
                Current Resumes
              </h2>
            </div>
          ...
          <div class="flex justify-center w-full lg:border-r border-gray-300 py-6">
            ...
            <div class="  w-1/2 pl-12">
              <h1 class="font-bold text-2xl lg:text-5xl tracking-1px">350</h1>
              <h2 class="text-base lg:text-lg mt-4 leading-8 tracking-wide">
